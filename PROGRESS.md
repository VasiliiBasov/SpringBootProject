...
**Текущий шаг:** 2 / 15 — Spring Boot автоконфигурация ✅ (4 микро-шага + мини-экзамен, 80%)
**Следующий шаг:** 3 — REST API: `@RestController` + `@GetMapping` / `@PostMapping` (формат v2 — микро-шаги)
**Процент:** 13% (2/15)
