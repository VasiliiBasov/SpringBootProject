...
- **Шаг:** 6 / 15 (Транзакции: `@Transactional`, micro-1 ✅ + micro-2 ✅ + мини-экзамен ✅, средний 83%)
- **Дата старта курса №2:** 28.08.2026 17:10
- **Дата последнего обновления:** 04.09.2026 (финал micro-2)
...
- **Всего потрачено:** **12.3 ч** (8.8 до + 3.5 за 04.09)
