...
- Под ним: **теория → практика → мини-экзамен → итог** (порядок утверждён учеником 28.08.2026)
...
### 3. Практика обязательна на каждом шаге (порядок: теория → практика → мини-экзамен)

❌ **Неправильно:** Теория → мини-экзамен → коммит. Без реального кода/эксперимента.

✅ **Правильно:** На каждом шаге **теория → практика → мини-экзамен**. Без практики шаг **не считается пройденным**. Порядок важен: сначала разобрались в теории, **потом** пощупали руками, **потом** проверили понимание вопросом.
...
> ⚠️ Слабый пример шага 1 (28.08.2026): ассистент сам сгенерил скелет и сам запустил. Ученик верно поправил — **«экзамен по чему ты проводишь?»**. Это было нарушением правила №3 (и порядка: был «теория → мини-экзамен», практики вообще не было). На шаге 2 и далее — **ждать явной работы от ученика**.
