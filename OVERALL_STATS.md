...
| 2 | **SpringBootProject** | Spring Boot + JPA + Security | ⏳ В процессе | 2 / 15 | 1.7 (старт 28.08.2026 17:10) | 77% | `SpringBootProject/COURSE_HANDBOOK.md` |
...
| SpringBootProject (Boot) | 28.08.2026 → _TBD_ | 1.7 (старт в 17:10) |
| **ИТОГО** | | **18.9 ч** |
