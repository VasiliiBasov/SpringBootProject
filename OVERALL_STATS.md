...
| 2 | **SpringBootProject** | Spring Boot + JPA + Security | ⏳ В процессе | 9 / 15 (шаг 9 закрыт) | 21.7 (старт 28.08.2026 17:10, последняя активность 11.09.2026 10:20); время шага 9 будет добавлено при закрытии сессии | ~82% (средний по 7 закрытым шагам) | `SpringBootProject/COURSE_HANDBOOK.md` |
...
| SpringBootProject (Boot) | 28.08.2026 → _TBD_ | 21.7 (старт в 17:10, активность 11.09.2026 10:20; время шага 9 будет добавлено при закрытии сессии) |
| **ИТОГО** | | **38.9 ч** |
...
*Файл скопирован из `SpringCoreProject` 28.08.2026 17:10 при старте курса №2. Последнее обновление: 11.09.2026 (после шага 9).*