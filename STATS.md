...
**Текущий шаг:** 6 / 15 — Транзакции: `@Transactional` (micro-1 ✅ + мини-экзамен ✅, 78%)
...
**Итого:** 8.8 ч (старт курса №2 — 28.08.2026 17:10, последняя активность 04.09.2026)
...
**Средний балл:** **65%** (9 тем, сумма 585/9 = 65). Упал с 77% после шага 6 — темы по транзакциям и propagation пока слабые (65%), это нормальный сигнал «что подтягивать».
**Средний балл по шагам (со средними по мини-экзаменам внутри шага):** шаг 2 — 80%, шаг 3 — 93%, шаг 4 — 85%, шаг 6 — 78% → общий **(80+93+85+78)/4 = 84%**. Этот показатель точнее отражает прогресс, потому что один шаг = одна тема с весом.
