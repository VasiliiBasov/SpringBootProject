...
**Текущий шаг:** 1 / 15 — Старт Spring Boot 🟡 (теория + мини-экзамен, **без практики** — см. примечание ниже)
...
| 2 | 28.08.2026 | Шаг 2: Spring Boot автоконфигурация — теория блоком v1 (отменено), v2 в работе (микро-шаги) | 0.3 |

**Итого:** 1.0 ч (старт курса №2 — 28.08.2026 17:10, активная работа до паузы в 18:39)
