...
**Текущий шаг:** 3 / 15 — REST API 🟡 (теория микро-шага 1, практика не начата)

**Последнее обновление:** 28.08.2026 21:19
...
| 4 | 28.08.2026 | Аудит .md файлов по запросу ученика | 0.1 |

**Итого:** 1.7 ч (старт курса №2 — 28.08.2026 17:10, последняя активность 21:19)
